...
namespace Caro_game.ViewModels
{
    public partial class MainViewModel
    {
        ...
        {
            bool isProfessionalLevel = SelectedAILevel == "Chuyên nghiệp";
            int baseSize = isProfessionalLevel ? 19 : 30;

            var board = new BoardViewModel(baseSize, baseSize, FirstPlayer, SelectedAILevel)
            {
